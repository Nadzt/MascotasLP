        ...
        for (let i = 0; i < 100; i++) {
            if(data[i].found != true){
                ...
                marker.addListener("click", () => {
                    ...
                    `<h6 style="border-bottom: #eaeaea solid 1px; padding-bottom: 0.1rem">${data[i].name}</h6>` +
                    ...
                    `<br>`+
                    `<div class="d-grid">` +
                    `<a href="/mascotas/${data[i]._id}" class="btn btn-sm btn-secondary" style="margin-top: .5rem">Ver Publicacion</a>` +
                    `</div>`;
