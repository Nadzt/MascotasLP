...
const displayPets = (Pets) => {
    for(let pet of Pets){
        ...
        if(pet.found == true) { 
            ...
            span.innerText = "Encontrado";
            h2.append(span);
        };
        div5.append(h2);
        let h5 = document.createElement("h5");
        h5.innerText = "Descripcion:";
        ...
        smallDescription.innerText = ` - ${pet.animal} raza ${pet.breed}, sexo ${pet.sex} , edad ${pet.age} perdido en ${pet.location}`;
